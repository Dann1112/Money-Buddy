...
import com.manrique.daniel.moneybuddy.DatabaseContract.Category;
import com.manrique.daniel.moneybuddy.DatabaseContract.CategoryItem;
import com.manrique.daniel.moneybuddy.DatabaseContract.Expense;
import com.manrique.daniel.moneybuddy.DatabaseContract.Income;
...
public class DatabaseOpenHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        final String CREATE_EXPENSE_TABLE = "CREATE TABLE " + Expense.TABLE_NAME + "(" +
                ...
                Expense.COLUMN_NAME_CATEGORY_ITEM_KEY + "INTEGER NOT NULL, " +
